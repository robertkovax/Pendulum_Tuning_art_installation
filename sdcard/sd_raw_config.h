#define XMEGA 1	// Milan Romic - Xmega defines
/*
 ...
 */
#if XMEGA	// Milan Romic - Xmega defines
...
#elif defined(__AVR_ATxmega128A1__)								// Milan Romic - Xmega defines
	#define configure_pin_mosi()	PORTD.DIRSET = 0x20;
	#define configure_pin_sck()		PORTD.DIRSET = 0x80;
	#define configure_pin_ss()		PORTD.DIRSET = 0x10;
	#define configure_pin_miso()	PORTD.DIRCLR = 0x40;

	#define select_card()			PORTD.OUTCLR = 0x10;
	#define unselect_card()			PORTD.OUTSET = 0x10;
#else
